...
function deserializeActionResult(res) {
  if (res.type === "error") {
    ...
    if (Object.assign(__vite_import_meta_env__$1, { DIR: "F:\\StableDiffusion\\framepack_cu126_torch26\\system", OS: "Windows_NT" })?.PROD) {
...
function serializeActionResult(res) {
  if (res.error) {
    if (Object.assign(__vite_import_meta_env__, { DIR: "F:\\StableDiffusion\\framepack_cu126_torch26\\system", OS: "Windows_NT" })?.DEV) {
...
const renderers = [];
const serializedData = [{ "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "type": "page", "component": "_server-islands.astro", "params": ["name"], "segments": [[{ "content": "_server-islands", "dynamic": false, "spread": false }], [{ "content": "name", "dynamic": true, "spread": false }]], "pattern": "^\\/_server-islands\\/([^/]+?)\\/?$", "prerender": false, "isIndex": false, "fallbackRoutes": [], "route": "/_server-islands/[name]", "origin": "internal", "distURL": [], "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/_image", "component": "node_modules/@astrojs/cloudflare/dist/entrypoints/image-transform-endpoint.js", "params": [], "pathname": "/_image", "pattern": "^\\/_image\\/?$", "segments": [[{ "content": "_image", "dynamic": false, "spread": false }]], "type": "endpoint", "prerender": false, "fallbackRoutes": [], "distURL": [], "isIndex": false, "origin": "internal", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/emoticons", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/emoticons\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "emoticons", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/emoticons.ts", "pathname": "/api/emoticons", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/photo", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/photo\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "photo", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/photo.ts", "pathname": "/api/photo", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/photos", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/photos\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "photos", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/photos.ts", "pathname": "/api/photos", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }];
serializedData.map(deserializeRouteInfo);
const _page0 = () => import("./image-transform-endpoint_CmFPSzTw.mjs").then((n2) => n2.i);
const _page1 = () => import("./emoticons_CpE5SNUr.mjs");
const _page2 = () => import("./photo_HkNpeaOm.mjs");
const _page3 = () => import("./photos_C5EgeynN.mjs");
const pageMap = /* @__PURE__ */ new Map([
  ["node_modules/@astrojs/cloudflare/dist/entrypoints/image-transform-endpoint.js", _page0],
  ["src/pages/api/emoticons.ts", _page1],
  ["src/pages/api/photo.ts", _page2],
  ["src/pages/api/photos.ts", _page3]
]);
const _manifest = deserializeManifest({"rootDir":"file:///F:/PeachyFangHomepage/","cacheDir":"file:///F:/PeachyFangHomepage/node_modules/.astro/","outDir":"file:///F:/PeachyFangHomepage/dist/","srcDir":"file:///F:/PeachyFangHomepage/src/","publicDir":"file:///F:/PeachyFangHomepage/public/","buildClientDir":"file:///F:/PeachyFangHomepage/dist/client/","buildServerDir":"file:///F:/PeachyFangHomepage/dist/server/","adapterName":"@astrojs/cloudflare","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/@astrojs/cloudflare/dist/entrypoints/image-transform-endpoint.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/emoticons","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/emoticons\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"emoticons","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/emoticons.ts","pathname":"/api/emoticons","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/photo","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/photo\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"photo","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/photo.ts","pathname":"/api/photo","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/photos","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/photos\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"photos","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/photos.ts","pathname":"/api/photos","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/[lang]/emoticons","isIndex":false,"type":"page","pattern":"^\\/([^/]+?)\\/emoticons\\/?$","segments":[[{"content":"lang","dynamic":true,"spread":false}],[{"content":"emoticons","dynamic":false,"spread":false}]],"params":["lang"],"component":"src/pages/[lang]/emoticons.astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/[lang]/photo","isIndex":false,"type":"page","pattern":"^\\/([^/]+?)\\/photo\\/?$","segments":[[{"content":"lang","dynamic":true,"spread":false}],[{"content":"photo","dynamic":false,"spread":false}]],"params":["lang"],"component":"src/pages/[lang]/photo.astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/[lang]/selfie","isIndex":false,"type":"page","pattern":"^\\/([^/]+?)\\/selfie\\/?$","segments":[[{"content":"lang","dynamic":true,"spread":false}],[{"content":"selfie","dynamic":false,"spread":false}]],"params":["lang"],"component":"src/pages/[lang]/selfie.astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/[lang]","isIndex":true,"type":"page","pattern":"^\\/([^/]+?)\\/?$","segments":[[{"content":"lang","dynamic":true,"spread":false}]],"params":["lang"],"component":"src/pages/[lang]/index.astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":true,"experimentalQueuedRendering":{"enabled":false,"poolSize":0,"contentCache":false},"componentMetadata":[["F:/PeachyFangHomepage/src/pages/[lang]/emoticons.astro",{"propagation":"none","containsHead":true}],["F:/PeachyFangHomepage/src/pages/[lang]/index.astro",{"propagation":"none","containsHead":true}],["F:/PeachyFangHomepage/src/pages/[lang]/photo.astro",{"propagation":"none","containsHead":true}],["F:/PeachyFangHomepage/src/pages/[lang]/selfie.astro",{"propagation":"none","containsHead":true}],["F:/PeachyFangHomepage/src/pages/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_DsBX4kaI.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_Csu6PJY6.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_CFl7y3Qj.mjs","\u0000virtual:astro:page:src/pages/[lang]/emoticons@_@astro":"chunks/emoticons_LNEtRq43.mjs","\u0000virtual:astro:page:src/pages/[lang]/photo@_@astro":"chunks/photo_QQMQMImi.mjs","\u0000virtual:astro:page:src/pages/[lang]/selfie@_@astro":"chunks/selfie_4MS8KjYi.mjs","\u0000virtual:astro:page:src/pages/[lang]/index@_@astro":"chunks/index_-PL-yAv6.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_snpJTZdv.mjs","virtual:cloudflare/worker-entry":"entry.mjs","\u0000virtual:astro:page:src/pages/api/emoticons@_@ts":"chunks/emoticons_CpE5SNUr.mjs","\u0000virtual:astro:page:src/pages/api/photo@_@ts":"chunks/photo_HkNpeaOm.mjs","\u0000virtual:astro:page:src/pages/api/photos@_@ts":"chunks/photos_C5EgeynN.mjs","F:/PeachyFangHomepage/node_modules/@astrojs/cloudflare/dist/entrypoints/image-service-workerd.js":"chunks/image-service-workerd_DDVL_7be.mjs","F:/PeachyFangHomepage/src/pages/[lang]/emoticons.astro?astro&type=script&index=0&lang.ts":"_astro/emoticons.astro_astro_type_script_index_0_lang.BmOd4QB6.js","F:/PeachyFangHomepage/src/pages/[lang]/photo.astro?astro&type=script&index=0&lang.ts":"_astro/photo.astro_astro_type_script_index_0_lang.ByJWAm-8.js","F:/PeachyFangHomepage/src/pages/[lang]/selfie.astro?astro&type=script&index=0&lang.ts":"_astro/selfie.astro_astro_type_script_index_0_lang.B3seSliT.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["F:/PeachyFangHomepage/src/pages/[lang]/emoticons.astro?astro&type=script&index=0&lang.ts","globalThis.process??={};globalThis.process.env??={};async function f(){const i=document.getElementById(\"emoticons-container\"),t=document.getElementById(\"toast\");if(i)try{const c=await fetch(\"/api/emoticons\");if(!c.ok)throw new Error(\"Failed to fetch emoticons\");const s=await c.json();if(i.innerHTML=\"\",s.length===0){const e=i.dataset.empty||\"No emoticons found.\";i.innerHTML=`<div style=\"grid-column: 1/-1; text-align: center; color: var(--text-muted);\">${e}</div>`;return}s.forEach(e=>{const n=document.createElement(\"div\");n.className=\"emoticon-card\",n.title=\"Click to copy to clipboard\";const p=(e.key.split(\"/\").pop()||e.key).split(\".\").slice(0,-1).join(\".\").replace(/_/g,\" \");n.innerHTML=`\n                    <img src=\"${e.url}\" alt=\"${p}\" loading=\"lazy\">\n                    <div class=\"emoticon-name\">${p}</div>\n                `,n.addEventListener(\"click\",async()=>{try{const d=await(await fetch(e.url)).blob();if(typeof ClipboardItem<\"u\")try{let a=d;if(d.type===\"image/svg+xml\"||e.url.includes(\".svg\")){const o=new Image;o.src=URL.createObjectURL(d),await new Promise((l,m)=>{o.onload=l,o.onerror=m});const r=document.createElement(\"canvas\");r.width=o.naturalWidth,r.height=o.naturalHeight;const w=r.getContext(\"2d\");if(w){w.drawImage(o,0,0);const l=await new Promise(m=>r.toBlob(m,\"image/png\"));l&&(a=l)}}const u=[new ClipboardItem({[a.type]:a})];if(await navigator.clipboard.write(u),t){const o=t.dataset.success||\"Copied to clipboard!\";t.innerText=o,t.classList.add(\"show\"),setTimeout(()=>t.classList.remove(\"show\"),2e3)}return}catch(a){console.warn(\"ClipboardItem write failed, falling back to URL copy\",a)}if(await navigator.clipboard.writeText(window.location.origin+e.url),t){const a=t.dataset.linkcopied||\"Link copied!\";t.innerText=a,t.classList.add(\"show\"),setTimeout(()=>t.classList.remove(\"show\"),2e3)}}catch(g){console.error(\"Failed to copy emoticon: \",g)}}),i.appendChild(n)})}catch(c){const s=i.dataset.failed||\"Failed to load emoticons.\";i.innerHTML=`<div style=\"grid-column: 1/-1; text-align: center; color: var(--primary-color);\">${s}</div>`,console.error(c)}}f();"],["F:/PeachyFangHomepage/src/pages/[lang]/photo.astro?astro&type=script&index=0&lang.ts","globalThis.process??={};globalThis.process.env??={};let b=[];const s=document.getElementById(\"gallery-grid\"),f=document.getElementById(\"loading-spinner\"),r=document.getElementById(\"search-bar\"),c=document.getElementById(\"clear-search\"),w=document.getElementById(\"no-results\"),y=document.getElementById(\"toast\");async function H(){try{const e=await fetch(\"/api/photos\");if(!e.ok)throw new Error(\"Failed to load photos\");b=e.ok?await e.json():[],C(b)}catch(e){if(console.error(e),f&&s){const h=s.dataset.failed||\"Failed to load gallery.\";f.innerHTML=`<p style=\"color:var(--primary-color);\">${h}</p>`}}}function C(e){if(f&&(f.style.display=\"none\"),!s)return;if(s.querySelectorAll(\".photo-card-container\").forEach(t=>t.remove()),e.length===0){w&&(w.style.display=\"block\");return}else w&&(w.style.display=\"none\");const v=s.dataset.labelcopy||\"Copy PNG\",i=s.dataset.labeldownload||\"Download\";e.forEach(t=>{const L=t.includes(\"landscape\")||t.includes(\"scene\")||t.includes(\"beach\"),n=document.createElement(\"div\");n.className=\"photo-card-container\",n.dataset.filename=t;const P=t.replace(/\\.[^/.]+$/,\"\").split(\"-\").map(l=>`<span class=\"tag-span\">${l}</span>`).join(\"\");n.innerHTML=`\n        <div class=\"photo-card-wrapper ${L?\"landscape\":\"\"}\">\n          <img src=\"/api/photo?key=${encodeURIComponent(t)}&type=preview\" alt=\"Preview of ${t}\" class=\"photo-image\" loading=\"lazy\" />\n          <div class=\"photo-tags-overlay\">\n            ${P}\n          </div>\n        </div>\n        \n        <div class=\"photo-actions-popout\">\n          <button class=\"action-btn copy\" title=\"Copy preview as PNG to clipboard\">\n            <span class=\"btn-icon\">📋</span> ${v}\n          </button>\n          <a class=\"action-btn download\" href=\"/api/photo?key=${encodeURIComponent(t)}&type=full\" download=\"${t}\" title=\"Download original photo\">\n            <span class=\"btn-icon\">💾</span> ${i}\n          </a>\n        </div>\n      `;const T=n.querySelector(\".photo-card-wrapper\");T&&T.addEventListener(\"click\",l=>{l.stopPropagation();const d=n.classList.contains(\"selected\");document.querySelectorAll(\".photo-card-container\").forEach(p=>{p.classList.remove(\"selected\")}),d||n.classList.add(\"selected\")});const o=n.querySelector(\".action-btn.copy\");o&&o.addEventListener(\"click\",async l=>{l.stopPropagation(),o.disabled=!0;const d=o.innerHTML;o.innerHTML='<span class=\"btn-icon\">⏳</span> ...';try{const p=`/api/photo?key=${encodeURIComponent(t)}&type=preview`,k=await(await fetch(p)).blob(),a=new Image;a.src=URL.createObjectURL(k),await new Promise((m,u)=>{a.onload=m,a.onerror=u});const g=document.createElement(\"canvas\");g.width=a.naturalWidth,g.height=a.naturalHeight;const I=g.getContext(\"2d\");if(I)I.drawImage(a,0,0),g.toBlob(async m=>{if(!m)throw new Error(\"Canvas PNG generation failed\");try{await navigator.clipboard.write([new ClipboardItem({\"image/png\":m})]);const u=y?.dataset.success||\"Copied to clipboard!\";y&&(y.innerText=u,y.classList.add(\"show\"),setTimeout(()=>y.classList.remove(\"show\"),2e3)),o.innerHTML=d,o.disabled=!1,n.classList.remove(\"selected\")}catch(u){console.error(\"Clipboard API write failed:\",u),o.innerHTML='<span class=\"btn-icon\">❌</span>',setTimeout(()=>{o.innerHTML=d,o.disabled=!1},2e3)}},\"image/png\");else throw new Error(\"Could not get 2D context\")}catch(p){console.error(\"Error loading/copying photo:\",p),o.innerHTML='<span class=\"btn-icon\">❌</span>',setTimeout(()=>{o.innerHTML=d,o.disabled=!1},2e3)}}),s.appendChild(n)})}function $(){if(!r)return;const e=r.value.trim().toLowerCase();if(e===\"\"){c&&(c.style.display=\"none\"),C(b);return}c&&(c.style.display=\"block\");const h=e.split(/\\s+/).filter(i=>i.length>0),v=b.filter(i=>{const L=i.toLowerCase().replace(/\\.[^/.]+$/,\"\").split(\"-\");return h.every(n=>L.some(E=>E.includes(n)||n.includes(E)))});C(v)}document.addEventListener(\"click\",()=>{document.querySelectorAll(\".photo-card-container\").forEach(e=>{e.classList.remove(\"selected\")})});r&&r.addEventListener(\"input\",$);c&&c.addEventListener(\"click\",()=>{r&&(r.value=\"\"),$()});H();"]],"assets":["/avatar_peachy.svg","/selfie_filter/selfie_cute_hearts.svg","/selfie_filter/selfie_peach_frame.svg","/_astro/selfie.astro_astro_type_script_index_0_lang.B3seSliT.js","/_astro/Layout.DUdhvQ8s.css","/_astro/photo.C6rBvpzh.css","/_astro/selfie.BEjY7NGo.css","/index.html"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"OLHMnv2Aoiu4G2IvR3CnPerC1s95RUxdbs50WEnwfUQ=","sessionConfig":{"driver":"unstorage/drivers/cloudflare-kv-binding","options":{"binding":"SESSION"}},"image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
export {
  ...
  isRemotePath as a,
  IncompatibleDescriptorOptions as b,
  ...
  joinPaths as j,
  renderTemplate as k,
  FontFamilyNotFound as l,
  maybeRenderHead as m,
  MissingGetFontFileRequestUrl as n,
