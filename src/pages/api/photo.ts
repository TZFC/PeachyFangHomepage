...
export const GET: APIRoute = async (context) => {
  ...
  const type = searchParams.get('type') || 'preview'; // 'preview' or 'full'
  ...
  if (!bucket) {
    // Determine orientation based on filename keywords
    ...
    // Generate a premium SVG placeholder styled with the PeachyFang palette
